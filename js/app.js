...
var allModels = [{modelName: 'Sea shrimp', modelURL: 'shrimp.jpg', difficulty: 5.5, tags: ['Living', 'Attacker'], description: 'A small shrimp, complete with two front claws and its distinguishable flexible tail.', webLink: '/sea-shrimp', time: '10-14 min'}, {modelName: 'A simple robot', modelURL: 'robot.jpg', difficulty: 7.5, tags: ['Attacker'], description: 'A robot that is ready to fight anything that comes in its way. Looks great on your desk!', webLink: '/simple-robot', time: '10-15 min'}];
